...
for i = 1:n
    ...
    for j = 1:ntrial
        ...
        nADC = 4;
        c_bs_2n_no4 = bs_mul(a, b, 2*nbit, nbit, nbit, nADC, nADC, nADC, 1);
        y4(i,j) = c_2n_no.double - c_bs_2n_no4.double;

        nADC = 5;
        c_bs_2n_no5 = bs_mul(a, b, 2*nbit, nbit, nbit, nADC, nADC, nADC, 1);
        y5(i,j) = c_2n_no.double - c_bs_2n_no5.double;

        nADC = 6;
        c_bs_2n_no6 = bs_mul(a, b, 2*nbit, nbit, nbit, nADC, nADC, nADC, 1);
        y6(i,j) = c_2n_no.double - c_bs_2n_no6.double;

        nADC = 7;
        c_bs_2n_no7 = bs_mul(a, b, 2*nbit, nbit, nbit, nADC, nADC, nADC, 1);
        y7(i,j) = c_2n_no.double - c_bs_2n_no7.double;

        nADC = 8;
        c_bs_2n_no8 = bs_mul(a, b, 2*nbit, nbit, nbit, nADC, nADC, nADC, 1);
...
title("n = 8 = 4 + 4, nDAC = no = nADC = " + nADC);
...
ax.FontSize = 30; 
box on;
filename = sprintf('8no_vs_8bs_4+4_nDAC=no=nADC=%d_mul_err_count.pdf', nADC);
